              ...
              <div className="grid-right">
                <div className="font-about">
                  ...
                  <div className="font-light padding-bottom-16">
                    I'm a student at Bina Nusantara University. I'm Binusian
                    2025 and undertaking a major in Master of Information
                    Technology. I'm interested in technology and passionate
            ...
            <div className="section-content">
              <div className="grid-left">
                <div className="font-left">
                  ...
                  <div className="font-light padding-bottom-16">
                    Lörem ipsum kvasida hybridkrig dma trafficking. Demitopi
                    platta till kurvan datalektiker för om vovis.
                  </div>
                  <div className="bar padding-bottom-16">
